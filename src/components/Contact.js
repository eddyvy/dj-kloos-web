        ...
        <div className="contact__main" id="contact">
            ...
            <div className="contact__links">
                <div className="contact__links-item">
                    <a href="https://www.facebook.com/kloos.music" target="_blank" rel="noreferrer">
                        <span>Facebook</span>
                        <img src="https://www.facebook.com/images/fb_icon_325x325.png" alt="facebook icon" />
                    </a>
                </div>
                <div className="contact__links-item">
                    <a href="https://www.instagram.com/kloos.wav/" target="_blank" rel="noreferrer">
                        <span>Instagram</span>
                ...
                <div className="contact__links-item">
                    <a href="https://twitter.com/itskloos" target="_blank" rel="noreferrer">
                        <span>Twitter</span>
            ...
            <div className="contact__links-item">
                <a href="mailto:kloos.info@gmail.com" target="_blank" rel="noreferrer">
